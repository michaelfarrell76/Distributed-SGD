    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 14: {
        if (tag == 114) {
          DO_(input->IncrementRecursionDepth());
         parse_loop_map_string_string:
          ::google::protobuf::scoped_ptr<TestArenaMapLite_MapStringStringEntry> entry(map_string_string_.NewEntry());
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtual(
              input, entry.get()));
          (*mutable_map_string_string())[entry->key()] = *entry->mutable_value();
          if (entry->GetArena() != NULL) entry.release();
      ...
      case 15: {
        if (tag == 122) {
          DO_(input->IncrementRecursionDepth());
         parse_loop_map_int32_bytes:
          ::google::protobuf::scoped_ptr<TestArenaMapLite_MapInt32BytesEntry> entry(map_int32_bytes_.NewEntry());
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtual(
              input, entry.get()));
          (*mutable_map_int32_bytes())[entry->key()] = *entry->mutable_value();
          if (entry->GetArena() != NULL) entry.release();
      ...
      case 18: {
        if (tag == 146) {
         ...
         parse_loop_map_int32_foreign_message_no_arena:
          ::google::protobuf::scoped_ptr<TestArenaMapLite_MapInt32ForeignMessageNoArenaEntry> entry(map_int32_foreign_message_no_arena_.NewEntry());
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtual(
              input, entry.get()));
