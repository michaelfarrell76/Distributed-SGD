...
class OldOptionType : public ::google::protobuf::Message {
 public:
  OldOptionType();
  ...
  static const TestEnum OLD_VALUE = OldOptionType_TestEnum_OLD_VALUE;
...
class NewOptionType : public ::google::protobuf::Message {
 public:
  NewOptionType();
  ...
  static const TestEnum OLD_VALUE = NewOptionType_TestEnum_OLD_VALUE;
  static const TestEnum NEW_VALUE = NewOptionType_TestEnum_NEW_VALUE;
  static inline bool TestEnum_IsValid(int value) {
...
class TestMessageWithRequiredEnumOption : public ::google::protobuf::Message {
 public:
