...
class DefaultValueTest : public ::google::protobuf::Message {
 public:
  ...
  static const EnumDefault ENUM_FIRST = DefaultValueTest_EnumDefault_ENUM_FIRST;
  static const EnumDefault ENUM_SECOND = DefaultValueTest_EnumDefault_ENUM_SECOND;
  static const EnumDefault ENUM_THIRD = DefaultValueTest_EnumDefault_ENUM_THIRD;
