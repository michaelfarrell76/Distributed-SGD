...
class TestField : public ::google::protobuf::Message {
 public:
  TestField();
  virtual ~TestField();
...
class TestDiffMessage_Item : public ::google::protobuf::Message {
 public:
...
class TestDiffMessage : public ::google::protobuf::Message {
 public:
  TestDiffMessage();
  ...
  bool has_v() const PROTOBUF_DEPRECATED;
  void clear_v() PROTOBUF_DEPRECATED;
  static const int kVFieldNumber = 13;
  ::google::protobuf::int32 v() const PROTOBUF_DEPRECATED;
  void set_v(::google::protobuf::int32 value) PROTOBUF_DEPRECATED;
  ...
  int rm_size() const PROTOBUF_DEPRECATED;
  void clear_rm() PROTOBUF_DEPRECATED;
  static const int kRmFieldNumber = 12;
  const ::protobuf_unittest::TestField& rm(int index) const PROTOBUF_DEPRECATED;
  ::protobuf_unittest::TestField* mutable_rm(int index) PROTOBUF_DEPRECATED;
  ::protobuf_unittest::TestField* add_rm() PROTOBUF_DEPRECATED;
  ::google::protobuf::RepeatedPtrField< ::protobuf_unittest::TestField >*
      mutable_rm() PROTOBUF_DEPRECATED;
  const ::google::protobuf::RepeatedPtrField< ::protobuf_unittest::TestField >&
      rm() const PROTOBUF_DEPRECATED;
