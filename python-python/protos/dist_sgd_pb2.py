...
SubTensor = _reflection.GeneratedProtocolMessageType('SubTensor', (_message.Message,), dict(
  ...
  __module__ = 'protos.dist_sgd_pb2'
...
def beta_create_ParamFeeder_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
  ...
  request_deserializers = {
    ('dist_sgd.ParamFeeder', 'GetUpdates'): protos.dist_sgd_pb2.SubTensor.FromString,
    ('dist_sgd.ParamFeeder', 'SendNextBatch'): protos.dist_sgd_pb2.PrevBatch.FromString,
    ('dist_sgd.ParamFeeder', 'SendParams'): protos.dist_sgd_pb2.ClientInfo.FromString,
    ('dist_sgd.ParamFeeder', 'ping'): protos.dist_sgd_pb2.empty.FromString,
  }
  response_serializers = {
    ('dist_sgd.ParamFeeder', 'GetUpdates'): protos.dist_sgd_pb2.StatusCode.SerializeToString,
    ('dist_sgd.ParamFeeder', 'SendNextBatch'): protos.dist_sgd_pb2.NextBatch.SerializeToString,
    ('dist_sgd.ParamFeeder', 'SendParams'): protos.dist_sgd_pb2.SubTensor.SerializeToString,
    ('dist_sgd.ParamFeeder', 'ping'): protos.dist_sgd_pb2.empty.SerializeToString,
  }
...
def beta_create_ParamFeeder_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
  ...
  import protos.dist_sgd_pb2
  request_serializers = {
    ('dist_sgd.ParamFeeder', 'GetUpdates'): protos.dist_sgd_pb2.SubTensor.SerializeToString,
    ('dist_sgd.ParamFeeder', 'SendNextBatch'): protos.dist_sgd_pb2.PrevBatch.SerializeToString,
    ('dist_sgd.ParamFeeder', 'SendParams'): protos.dist_sgd_pb2.ClientInfo.SerializeToString,
    ('dist_sgd.ParamFeeder', 'ping'): protos.dist_sgd_pb2.empty.SerializeToString,
  }
  response_deserializers = {
    ('dist_sgd.ParamFeeder', 'GetUpdates'): protos.dist_sgd_pb2.StatusCode.FromString,
    ('dist_sgd.ParamFeeder', 'SendNextBatch'): protos.dist_sgd_pb2.NextBatch.FromString,
    ('dist_sgd.ParamFeeder', 'SendParams'): protos.dist_sgd_pb2.SubTensor.FromString,
    ('dist_sgd.ParamFeeder', 'ping'): protos.dist_sgd_pb2.empty.FromString,
  }
  cardinalities = {
