...
def beta_create_PaxosServer_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
  ...
  request_deserializers = {
    ('dist_sgd.PaxosServer', 'accept'): protos.paxos_pb2.request_acceptance.FromString,
    ('dist_sgd.PaxosServer', 'accepted'): protos.paxos_pb2.consensus.FromString,
    ('dist_sgd.PaxosServer', 'ping'): protos.paxos_pb2.empty.FromString,
    ('dist_sgd.PaxosServer', 'prepare'): protos.paxos_pb2.proposal.FromString,
  }
  response_serializers = {
    ('dist_sgd.PaxosServer', 'accept'): protos.paxos_pb2.acquiescence.SerializeToString,
    ('dist_sgd.PaxosServer', 'accepted'): protos.paxos_pb2.empty.SerializeToString,
    ('dist_sgd.PaxosServer', 'ping'): protos.paxos_pb2.empty.SerializeToString,
    ('dist_sgd.PaxosServer', 'prepare'): protos.paxos_pb2.ack.SerializeToString,
  }
...
def beta_create_PaxosServer_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
  ...
  import protos.paxos_pb2
  request_serializers = {
    ('dist_sgd.PaxosServer', 'accept'): protos.paxos_pb2.request_acceptance.SerializeToString,
    ('dist_sgd.PaxosServer', 'accepted'): protos.paxos_pb2.consensus.SerializeToString,
    ('dist_sgd.PaxosServer', 'ping'): protos.paxos_pb2.empty.SerializeToString,
    ('dist_sgd.PaxosServer', 'prepare'): protos.paxos_pb2.proposal.SerializeToString,
  }
  response_deserializers = {
    ('dist_sgd.PaxosServer', 'accept'): protos.paxos_pb2.acquiescence.FromString,
    ('dist_sgd.PaxosServer', 'accepted'): protos.paxos_pb2.empty.FromString,
    ('dist_sgd.PaxosServer', 'ping'): protos.paxos_pb2.empty.FromString,
    ('dist_sgd.PaxosServer', 'prepare'): protos.paxos_pb2.ack.FromString,
  }
  cardinalities = {
